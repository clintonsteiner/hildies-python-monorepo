...
class TestFetchCommand:
    ...
    @patch("hildie.hildie_archive_git_forks.main.get_github_username")
    @patch("hildie.hildie_archive_git_forks.main.get_env_or_fail")
    @patch("hildie.hildie_archive_git_forks.main.ArchiveForks")
